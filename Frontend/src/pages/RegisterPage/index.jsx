        ...
        <aside className="relative hidden overflow-hidden bg-primary p-14 lg:flex lg:flex-col lg:justify-center">
          ...
          <div className="relative z-10 max-w-xl space-y-8 text-primary-foreground">
            ...
            <p className="text-base leading-relaxed text-primary-foreground/90">
              Create your workspace and start screening resumes with AI-powered
              ranking, skill matching, and hiring insights.
            </p>
          </div>
        </aside>
        ...
        <main className="flex items-center justify-center p-6 sm:p-10">
          <Card className="w-full max-w-md border-border/80">
            <CardHeader>
              ...
              <CardDescription>
                Set up your AI Resume Screener workspace.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form className="space-y-5" onSubmit={handleSubmit}>
                <label className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input className="h-11 pl-9" placeholder="Your full name" />
                  </div>
                </label>
                ...
                <label className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>
                    I agree to the <span className="font-semibold text-foreground">Terms</span>{" "}
