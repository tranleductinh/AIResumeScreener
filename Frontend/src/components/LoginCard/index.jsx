...
const LoginCard = ({
  ...
  return (
    <Card className="w-full max-w-md border-border/80">
      ...
      <CardContent>
        <form className="space-y-5" onSubmit={onSubmitEmailLogin}>
          ...
          <Button type="submit" className="mt-1 h-11 w-full" disabled={loading || googleLoading}>
          ...
          >
            ...
            {googleLoading ? "Connecting Google..." : "Login with Google"}
          </Button>
